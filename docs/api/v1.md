...
The prefix of V1 API is `/v1/`, you should add this prefix to every routes below if there are no specific comment.

This API support cache.
...
- Response:
	...
	- Payload:
		```js
		{
			...
			"version": 1, // The api version, should be always 1
		}
		```
