...
ALTER TABLE plugins ADD `lastRelease` DATETIME DEFAULT NULL;
ALTER TABLE plugins MODIFY `lastUpdate` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
