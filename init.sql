...
ALTER TABLE plugins ADD `createAt`   DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL;
ALTER TABLE plugins ADD `lastUpdate` DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL;
